...
const catalogLevelSeeds: readonly LevelSeed[] = [
  ...
  },
  {
    ...
    prepPrime: 'squat',
    progressionFromPrevious: progressionEvidence(['output'], 'changed fields: primary.prescription.rir'),
  ...
  },
  {
    ...
    optional: 'face-pull',
    prepPrime: 'squat',
    progressionFromPrevious: progressionEvidence(['volume', 'density'], 'changed fields: primary.prescription.sets, primary.prescription.reps, primary.restSeconds'),
