...
const basePrescriptionByLevel: Readonly<Record<Female111TemplateLevelId, Prescription>> = {
  ...
  l3: { sets: 3, reps: { min: 8, max: 10 }, rir: 2, tempo: '3-1-2', rom: 'full controlled range' },
  l4: { sets: 4, reps: { min: 6, max: 8 }, rir: 2, tempo: '2-0-2', rom: 'full controlled range' },
}
...
const mainAction = (
  ...
  return {
    ...
    restSeconds: role === 'PRIMARY' ? 60 : 30,
...
const catalogLevelSeeds: readonly LevelSeed[] = [
  ...
  },
  {
    ...
    prepPrime: 'squat',
    progressionFromPrevious: progressionEvidence(['volume', 'range'], 'changed fields: primary.prescription.sets, primary.prescription.reps, primary.prescription.rom'),
  ...
  },
  {
    ...
    prepPrime: 'squat',
    progressionFromPrevious: progressionEvidence(['output', 'range'], 'changed fields: primary.prescription.rir, primary.prescription.rom'),
  ...
  },
  {
    ...
    optional: 'face-pull',
    prepPrime: 'squat',
    progressionFromPrevious: progressionEvidence(['volume', 'control'], 'changed fields: primary.prescription.sets, primary.prescription.reps, primary.prescription.tempo'),
