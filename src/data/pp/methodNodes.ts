...
export const ppMethodNodes: readonly PPMethodNode[] = [
  ...
  node({ readinessProfile: 'rotation-integration', id: 'pp13', source: source('PP13', '高位支撑前跨步转体'), kind: 'variant', mapping: mapping.variant('high-plank-step-through', 'pp13-high-plank-step-through-rotation'), primaryPathway: 'integration', secondaryPathways: ['support', 'locomotion', 'thoracic-rotation'], progressionLevel: 'P3', role: 'integration', capabilities: ['shoulder-support', 'anti-rotation', 'rotation', 'locomotion', 'force-transfer', 'hip-flexion'] }),
  node({ readinessProfile: 'dynamic-support', id: 'pp14', source: source('PP14', '高位平板前跨步'), kind: 'exercise', mapping: mapping.mapped('high-plank-step-through'), primaryPathway: 'support', secondaryPathways: ['locomotion'], progressionLevel: 'P3', role: 'bridge', capabilities: ['shoulder-support', 'anti-extension', 'weight-shift', 'locomotion', 'hip-flexion'] }),
  node({ readinessProfile: 'dynamic-support', id: 'pp15', source: source('PP15', '支撑膝撞'), kind: 'exercise', mapping: mapping.mapped('cross-body-plank-knee-drive'), primaryPathway: 'support', progressionLevel: 'P3', role: 'bridge', capabilities: ['shoulder-support', 'anti-extension', 'weight-shift', 'hip-flexion'] }),
  ...
  node({ readinessProfile: 'dynamic-support', id: 'exp-plank-march', kind: 'variant', mapping: mapping.variant('plank', 'exp-plank-march'), primaryPathway: 'support', secondaryPathways: ['locomotion'], progressionLevel: 'P2', role: 'bridge', capabilities: ['shoulder-support', 'anti-rotation', 'weight-shift', 'locomotion', 'hip-flexion'] }),
  node({ readinessProfile: 'dynamic-support', id: 'exp-short-forward-step-high-plank', kind: 'variant', mapping: mapping.variant('high-plank-step-through', 'exp-short-forward-step-high-plank'), primaryPathway: 'support', secondaryPathways: ['locomotion'], progressionLevel: 'P2', role: 'bridge', capabilities: ['shoulder-support', 'anti-extension', 'weight-shift', 'locomotion', 'hip-flexion'] }),
