...
export const ppMethodNodes: readonly PPMethodNode[] = [
  ...
  node({ id: 'pp06', source: source('PP06', '坐姿骨盆髋走'), kind: 'drill', mapping: mapping.methodOnly(), primaryPathway: 'hip-rotation', progressionLevel: 'P1', role: 'drill', capabilities: ['pelvic-control', 'weight-shift', 'breathing-control'], breathing: resetBreathing }),
  node({ id: 'pp07', source: source('PP07', '低位鸭步'), kind: 'exercise', mapping: mapping.add('duck-walk'), primaryPathway: 'locomotion', secondaryPathways: ['squat', 'frontal-plane'], progressionLevel: 'P3', role: 'integration', capabilities: ['locomotion', 'weight-shift', 'hip-abduction'] }),
  node({ id: 'pp08', source: source('PP08', '侧卧髋内收'), kind: 'exercise', mapping: mapping.add('side-lying-hip-adduction'), primaryPathway: 'lateral-support', progressionLevel: 'P1', role: 'foundation', capabilities: ['hip-adduction', 'pelvic-control'] }),
  ...
  node({ id: 'pp14', source: source('PP14', '高位平板前跨步'), kind: 'exercise', mapping: mapping.add('high-plank-step-through'), primaryPathway: 'support', secondaryPathways: ['locomotion'], progressionLevel: 'P3', role: 'bridge', capabilities: ['shoulder-support', 'anti-extension', 'weight-shift', 'locomotion'] }),
  ...
  node({ id: 'pp20', source: source('PP20', '四足支撑'), kind: 'exercise', mapping: mapping.methodOnly(), primaryPathway: 'support', progressionLevel: 'P0', role: 'foundation', capabilities: ['shoulder-support', 'rib-pelvis-control', 'breathing-control'], breathing: resetBreathing }),
  ...
  node({ id: 'pp23', source: source('PP23', '普拉提单腿伸展'), kind: 'exercise', mapping: mapping.add('pilates-single-leg-stretch'), primaryPathway: 'core', progressionLevel: 'P3', role: 'integration', capabilities: ['anti-extension', 'breathing-control', 'contralateral-control'] }),
  node({ id: 'pp24', source: source('PP24', '普拉提双腿伸展'), kind: 'exercise', mapping: mapping.add('pilates-double-leg-stretch'), primaryPathway: 'core', progressionLevel: 'P4', role: 'integration', capabilities: ['anti-extension', 'breathing-control', 'force-transfer'] }),
  node({ id: 'pp25', source: source('PP25', '普拉提十字交叉'), kind: 'exercise', mapping: mapping.add('pilates-criss-cross'), primaryPathway: 'core', secondaryPathways: ['thoracic-rotation'], progressionLevel: 'P4', role: 'integration', capabilities: ['anti-extension', 'rotation', 'breathing-control'] }),
  ...
  node({ id: 'exp-standard-side-plank', kind: 'exercise', mapping: mapping.add('side-plank'), primaryPathway: 'lateral-support', progressionLevel: 'P2', role: 'base', capabilities: ['anti-lateral-flexion', 'shoulder-support', 'pelvic-control'] }),
  ...
  node({ id: 'exp-single-leg-glute-bridge', kind: 'exercise', mapping: mapping.add('single-leg-glute-bridge'), primaryPathway: 'hip-extension', secondaryPathways: ['core'], progressionLevel: 'P3', role: 'integration', capabilities: ['hip-extension', 'pelvic-control', 'anti-rotation'] }),
  ...
  node({ id: 'exp-long-lever-side-lying-adduction', kind: 'variant', mapping: mapping.variant('side-lying-hip-adduction', 'exp-long-lever-side-lying-adduction'), primaryPathway: 'lateral-support', progressionLevel: 'P2', role: 'bridge', capabilities: ['hip-adduction', 'pelvic-control', 'anti-lateral-flexion'] }),
  ...
  node({ id: 'exp-standing-march', kind: 'exercise', mapping: mapping.add('standing-march'), primaryPathway: 'locomotion', secondaryPathways: ['frontal-plane'], progressionLevel: 'P1', role: 'base', capabilities: ['weight-shift', 'contralateral-control', 'hip-abduction'] }),
  node({ id: 'exp-open-book', kind: 'variant', mapping: mapping.mapped('side-lying-open-book'), primaryPathway: 'thoracic-rotation', secondaryPathways: ['breath'], progressionLevel: 'P0', role: 'foundation', capabilities: ['rotation', 'breathing-control'] }),
