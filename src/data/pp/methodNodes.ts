...
export const ppMethodNodes: readonly PPMethodNode[] = [
  ...
  node({ id: 'pp07', source: source('PP07', '低位鸭步'), kind: 'exercise', mapping: mapping.add('duck-walk'), primaryPathway: 'locomotion', secondaryPathways: ['squat', 'frontal-plane'], progressionLevel: 'P3', role: 'optional', capabilities: ['locomotion', 'weight-shift', 'hip-abduction'] }),
  node({ id: 'pp08', source: source('PP08', '侧卧髋内收'), kind: 'exercise', mapping: mapping.add('side-lying-hip-adduction'), primaryPathway: 'frontal-plane', secondaryPathways: ['lateral-support'], progressionLevel: 'P1', role: 'foundation', capabilities: ['hip-adduction', 'pelvic-control'] }),
