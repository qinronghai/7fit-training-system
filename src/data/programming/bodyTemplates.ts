...
const body02L1 = level(
  ...
  [strengthBlock([
    ...
    exercise({ exerciseKey: 'rear-delt-fly', displayName: '反向飞鸟', role: 'ACCESSORY', movementPattern: 'hpush', laterality: 'bilateral', fatigueRisk: 'low', prescription: { sets: 2, reps: { min: 12, max: 15 }, rir: { min: 2, max: 3 } } }),
...
const body02L2 = level(
  ...
  [strengthBlock([
    ...
    exercise({ exerciseKey: 'rear-delt-fly', displayName: '反向飞鸟', role: 'ACCESSORY', movementPattern: 'hpush', laterality: 'bilateral', fatigueRisk: 'low', prescription: { sets: 2, reps: { min: 12, max: 15 }, rir: 2 } }),
